...
class House{
    ...
    public $floor;
        ...
        public static function create(){
            ...
            $stmt->bind_param("siii", $_POST['address'], $_POST['roomCount'], $_POST['buldingType'], $_POST['floor']);
           $stmt->execute();
            // if(!$stmt->execute()) {
    ...
    public function update(){       
            $db = new DB();
                        ...
                        $stmt = $db->conn->prepare("UPDATE `namuciai` SET `address`= ? ,`room_count`= ? ,`is_house`= ? , `floor`= ?  WHERE `id` = ?");
